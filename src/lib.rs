...
pub use lexer_gen::nfa::{Nfa, NfaState, SymbolTransition, TransitionSymbol, build_nfa_from_unified_spec};
...
pub use lexer_gen::codegen::{
    generate_dfa_table_module,
    generate_rust_match_scanner,
    write_generated_scanner_to,
};
pub use pipeline::{
    AnnotatedRuleRegex,
    UnifiedRegexSpec,
    build_unified_regex_spec,
    generate_scanner_artifacts,
};
